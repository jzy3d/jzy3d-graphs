...
//Quality.Advanced, "awt"
    ...
    protected void updateEdgeLineSourceCoordinate(Edge e, LineStrip ls) {
        Node n1 = e.getSource();
        NodeData nd1 = n1.getNodeData();
        ls.get(0).xyz.x = nd1.x();
        ls.get(0).xyz.y = nd1.y();
        ls.get(0).xyz.z = nd1.z();
        ls.updateBounds();
    }
    ...
    protected void updateEdgeLineTargetCoordinate(Edge e, LineStrip ls) {
        Node n2 = e.getTarget();
        NodeData nd2 = n2.getNodeData();
        ls.get(1).xyz.x = nd2.x();
        ls.get(1).xyz.y = nd2.y();
        ls.get(1).xyz.z = nd2.z();
        ls.updateBounds();
    }
    ...
    protected Map<Integer, Point> nodePoint = new HashMap<Integer, Point>();
    protected Map<Integer, Sphere> nodeRepresentation = new HashMap<Integer, Sphere>();
    protected Map<Integer, DrawableTextWrapper> nodeLabelRepresentation = new HashMap<Integer, DrawableTextWrapper>();
    protected Map<Integer, LineStrip> edgeRepresentation = new HashMap<Integer, LineStrip>();
}
