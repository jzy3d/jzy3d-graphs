...
public class GephiController {
    ...
    public void randomizeGraphLayout(GraphModel g){        
        for(Node n: g.getGraph().getNodes()){
            n.getNodeData().setX((float)Math.random());
            n.getNodeData().setY((float)Math.random());
            n.getNodeData().setZ((float)Math.random());
        }
    }
    ...
    public void sizeWithNodeNeighbourCount(GraphModel g){
        for(Node n: g.getGraph().getNodes()){
            ...
            n.getNodeData().setSize(Math.min(c,1));
        }
    }
    ...
    public Node addNode(String name, boolean memorize) {
        ...
        node.getNodeData().setLabel("Node " + nn);
    ...
    public void addEdge(String n1, String n2, float value) {
        addEdge(n1, n2, value, false);
    }
    
    public void addEdge(String n1, String n2, float value, boolean onlyIfNon0) {
