 ...
 * <li>Filter with partition, keep nodes with 'source' column equal to 'Blogorama'</li>
 * <li>Intersection between degrees and partition, AND filter with two precedent filters</li>
 * <li>Ego filter</li></ul>
 * <p>
 ...
 * can be chained by setting sub-queries. A query is a tree where the root is the
