 ...
 * as PDF files.
 * <p>
 * Workspaces are the container for all data and are manipulated from the Project
 * Controller. The demo show key aspects:
 * <ul><li>How to duplicate a workspace.</li>
 * <li>How to set a workspace as the "current" workspace. This is very useful as
 * many modules just do their job on this current workspace and doesn't allow
 * to specify which workspace to work on from the API. Therefore it is often
