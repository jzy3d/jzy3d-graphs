...
public class GephiGraphGenerator {
  ...
  public void wattsStrogatz(Workspace workspace, int n, int n2, double wiringProba) {
    ...
    /*
     * WattsStrogatz wattsStrogatz = new WattsStrogatz(); wattsStrogatz.setNumberOfNodes(n);
     * wattsStrogatz.setNumberOfNeighbors(n2); wattsStrogatz.setRewiringProbability(wiringProba);
