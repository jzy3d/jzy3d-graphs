...
public class GephiLayoutController {
  ...
  /*
   * public GraphSheet getGraphSheet(){ return getGraphSheet(null); }
   */

  /*
   * public GraphSheet getGraphSheet(Workspace workspace){ projectController =
   * Lookup.getDefault().lookup(ProjectController.class);
   * 
   * //if(workspace!=null) projectController.openWorkspace(workspace);
   * 
   * PreviewControllerImpl controller; if(!workspacePreview.containsKey(workspace)){ controller =
   * (PreviewControllerImpl)Lookup.getDefault().lookup(PreviewController.class);
   * workspacePreview.put(workspace, controller); } else{ controller =
   * (PreviewControllerImpl)workspacePreview.get(workspace); } controller.buildGraph();
  ...
  /*
   * public GraphController getGraphController() { return graphController; }
   * 
   * public PreviewController getPreviewController() { return vc; }
   */
  ...
  protected Map<Workspace, PreviewController> workspacePreview =
      new HashMap<Workspace, PreviewController>();
}
